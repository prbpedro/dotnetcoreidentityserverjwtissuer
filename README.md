...
1. Create a new empty Database that should contain the settings of the structures needed to run IdentityServer4. Later in this tutorial, I will show you how to create the needed structures mentioned.
